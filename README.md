...
Besides creating apps, Rekit also provides powerful tools for managing the project:
 ...
 1. [Command line tools](http://rekit.js.org/docs/cli.html): you can use these tools to create/rename/move/delete project elements like components, actions etc.
