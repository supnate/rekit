...
> Rekit 2.0 is coming! You could try it by `npm install -g rekit@next`. Note that the docs here are mainly for 1.0. There will be slight changes for 2.0, but don't worry, it will be fully compatible with 1.0 apps :-P.
