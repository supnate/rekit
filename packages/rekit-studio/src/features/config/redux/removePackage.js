  ...
  return (dispatch) => { // optionally you can have getState as the second argument
    ...
    const promise = new Promise((resolve, reject) => {
      ...
      doRequest.then(
        (res) => {
          dispatch({
            type: CONFIG_REMOVE_PACKAGE_SUCCESS,
            data: res,
          });
          resolve(res);
        },
        ...
        (err) => {
          dispatch({
            type: CONFIG_REMOVE_PACKAGE_FAILURE,
            data: { error: err },
          });
          reject(err);
        },
...
export function dismissRemovePackageError() {
  return {
...
export function reducer(state, action) {
  switch (action.type) {
    case CONFIG_REMOVE_PACKAGE_BEGIN:
    ...
    case CONFIG_REMOVE_PACKAGE_SUCCESS:
    ...
    case CONFIG_REMOVE_PACKAGE_FAILURE:
      // The request is failed
      return {
        ...state,
        removePackagePending: false,
        removePackageError: action.data.error,
      };

    case CONFIG_REMOVE_PACKAGE_DISMISS_ERROR:
