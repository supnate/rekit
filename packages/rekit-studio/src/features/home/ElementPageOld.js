...
export class ElementPageOld extends Component {
  static propTypes = {
  ...
  renderNotFound() {
    return (
      <div className="home-element-page-old">
...
export default connect(mapStateToProps, mapDispatchToProps)(ElementPageOld);
