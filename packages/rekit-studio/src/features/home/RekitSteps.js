  ...
  render() {
    return (
      <div className="home-rekit-steps">
        ...
        <p>
          Though this demo is readonly, you can try a full-featured Rekit Studio by creating your own Rekit app. It&apos;s super easy!
        </p>
        <br />
        <Steps>
        ...
        <p>Then access <a href="http://localhost:6075" target="_blank">http://localhost:6075</a> for your app. <a href="http://localhost:6076" target="_blank">http://localhost:6076</a> for Rekit Studio.</p>
