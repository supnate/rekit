/* eslint-disable */
/* PrismJS 1.13.0
http://prismjs.com/download.html#themes=prism-dark&languages=markup+css+clike+javascript+jsx+typescript+tsx */
var _self =
    ...
    var e = /\blang(?:uage)?-(\w+)\b/i,
      ...
      n = (_self.Prism = {
          ...
          clone: function(e, t) {
            ...
            switch (((t = t || {}), r)) {
              case 'Object':
                ...
                var a = {};
                t[n.util.objId(e)] = a;
                for (var i in e) e.hasOwnProperty(i) && (a[i] = n.util.clone(e[i], t));
                return a;
              case 'Array':
                if (t[n.util.objId(e)]) return t[n.util.objId(e)];
                var a = [];
          ...
          insertBefore: function(e, t, r, a) {
            ...
            for (var s in i)
              if (i.hasOwnProperty(s)) {
                if (s == t) for (var l in r) r.hasOwnProperty(l) && (o[l] = r[l]);
                o[s] = i[s];
              }
            return (
              ...
              e.hasOwnProperty(i) &&
                ...
                'Object' !== n.util.type(e[i]) || a[n.util.objId(e[i])]
                  ? 'Array' !== n.util.type(e[i]) ||
                    a[n.util.objId(e[i])] ||
                    ((a[n.util.objId(e[i])] = !0), n.languages.DFS(e[i], t, i, a))
                  : ((a[n.util.objId(e[i])] = !0), n.languages.DFS(e[i], t, null, a)));
          },
        },
        plugins: {},
        ...
        highlight: function(e, t, a) {
          var i = { text: e, grammar: t, language: a };
          return (
            (i.tokens = n.tokenize(e, t)), n.hooks.run('after-tokenize', i), r.stringify(n.util.encode(i.tokens), a)
          );
        },
                ...
                for (var b = a, k = i; b < t.length; k += t[b].length, ++b) {
                  ...
                  if (!(w instanceof s)) {
                    ...
                    if (!_ && m && b != t.length - 1) {
                      ...
                      for (
                        var P = _.index + (d ? _[1].length : 0), A = _.index + _[0].length, x = b, O = k, I = t.length;
          ...
          ('string' != typeof o &&
            ('tag' === o.type && o.content[0] && 'tag' === o.content[0].type
              ? '</' === o.content[0].content[0].content
                ? s.length > 0 && s[s.length - 1].tagName === e(o.content[0].content[1]) && s.pop()
                : '/>' === o.content[o.content.length - 1].content ||
                  s.push({ tagName: e(o.content[0].content[1]), openedBraces: 0 })
              : s.length > 0 && 'punctuation' === o.type && '{' === o.content
                ? s[s.length - 1].openedBraces++
                : s.length > 0 && s[s.length - 1].openedBraces > 0 && 'punctuation' === o.type && '}' === o.content
                  ? s[s.length - 1].openedBraces--
                  : (i = !0)),
